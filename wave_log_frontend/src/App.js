...
const initialSessions = [
  // A rich, realistic sample of sessions spanning 5 spots, all boards, all moods, conditions, and distributed over months
  // Variety ensures charts/stats are meaningful and colorful
  // Recent years, spring-summer
  {
    id: 1, date: '2024-06-13', spot: 'Seaglass Beach', board: 'Shortboard', waveCount: 15, mood: 'Stoked',
    notes: 'Fun chest-high lefts, light crowd. Dolphins spotted!', swellSize: 4, wind: 'Offshore', tide: 'Mid',
  },
  { id: 2, date: '2024-06-10', spot: 'Crystal Cove', board: 'Longboard', waveCount: 9, mood: 'Relaxed',
    notes: 'Gentle rollers, easy logging.', swellSize: 2, wind: 'Onshore', tide: 'High',
  },
  { id: 3, date: '2024-06-07', spot: 'Seaglass Beach', board: 'Funboard', waveCount: 11, mood: 'Frustrated',
    notes: 'Windy, choppy, hard to catch the set waves.', swellSize: 5, wind: 'Sideshore', tide: 'Low',
  },
  { id: 4, date: '2024-06-01', spot: 'Coral Point', board: 'Fish', waveCount: 13, mood: 'Inspired',
    notes: 'Epic sunrise session, glassy faces.', swellSize: 6, wind: 'Offshore', tide: 'Low',
  },
  { id: 5, date: '2024-05-29', spot: 'Tide Rock', board: 'Shortboard', waveCount: 8, mood: 'Tired',
    notes: 'Heavy paddle after work, bigger closeouts than expected.', swellSize: 7, wind: 'Onshore', tide: 'Mid',
  },
  { id: 6, date: '2024-05-25', spot: 'Lagoon Bay', board: 'Funboard', waveCount: 10, mood: 'Relaxed',
    notes: 'High tide but mellow with a sea turtle encounter!', swellSize: 3, wind: 'Sideshore', tide: 'High',
  },
  { id: 7, date: '2024-05-20', spot: 'Crystal Cove', board: 'Soft-top', waveCount: 7, mood: 'Stoked',
    notes: 'Friends, sun, and playful waves.', swellSize: 4, wind: 'Offshore', tide: 'Low',
  },
  { id: 8, date: '2024-05-12', spot: 'Seaglass Beach', board: 'Longboard', waveCount: 12, mood: 'Inspired',
    notes: 'Noserides for days; warm water sets.', swellSize: 3, wind: 'Onshore', tide: 'High',
  },
  { id: 9, date: '2024-05-08', spot: 'Coral Point', board: 'Fish', waveCount: 6, mood: 'Frustrated',
    notes: 'Late start, missed best tide, crowded lineup.', swellSize: 3, wind: 'Onshore', tide: 'Mid',
  },
  { id: 10, date: '2024-05-03', spot: 'Lagoon Bay', board: 'Shortboard', waveCount: 10, mood: 'Stoked',
    notes: 'Perfect form, little barrels!', swellSize: 5, wind: 'Offshore', tide: 'Low',
  },
  { id: 11, date: '2024-04-29', spot: 'Crystal Cove', board: 'Funboard', waveCount: 7, mood: 'Tired',
    notes: 'Late afternoon chop, but beautiful sunset.', swellSize: 2, wind: 'Sideshore', tide: 'High',
  },
  { id: 12, date: '2024-04-23', spot: 'Tide Rock', board: 'Longboard', waveCount: 9, mood: 'Relaxed',
    notes: 'Mellow logging, glassy conditions.', swellSize: 4, wind: 'Offshore', tide: 'Mid',
  },
  { id: 13, date: '2024-04-17', spot: 'Seaglass Beach', board: 'Shortboard', waveCount: 16, mood: 'Stoked',
    notes: 'Fast rights, best session in months!', swellSize: 6, wind: 'Sideshore', tide: 'Low',
  },
  { id: 14, date: '2024-04-12', spot: 'Coral Point', board: 'Soft-top', waveCount: 5, mood: 'Tired',
    notes: 'First lesson with my cousin – lots of wipeouts.', swellSize: 2, wind: 'Onshore', tide: 'High',
  },
  { id: 15, date: '2024-04-09', spot: 'Tide Rock', board: 'Fish', waveCount: 11, mood: 'Inspired',
    notes: 'Steep drops and tons of energy after coffee!', swellSize: 7, wind: 'Offshore', tide: 'Mid',
  },
  { id: 16, date: '2024-04-01', spot: 'Lagoon Bay', board: 'Longboard', waveCount: 13, mood: 'Relaxed',
    notes: 'Early dawn patrol, mist over the ocean.', swellSize: 4, wind: 'Onshore', tide: 'Low',
  },
  { id: 17, date: '2024-03-27', spot: 'Crystal Cove', board: 'Shortboard', waveCount: 14, mood: 'Stoked',
    notes: 'Late season push, strong sets, fast paddle-outs.', swellSize: 5, wind: 'Offshore', tide: 'Mid',
  },
  { id: 18, date: '2024-03-21', spot: 'Tide Rock', board: 'Funboard', waveCount: 8, mood: 'Frustrated',
    notes: 'Windy, tough finds, long lulls.', swellSize: 5, wind: 'Sideshore', tide: 'High',
  },
  { id: 19, date: '2024-03-13', spot: 'Coral Point', board: 'Shortboard', waveCount: 18, mood: 'Inspired',
    notes: 'Photographer on beach, best air of the year!', swellSize: 7, wind: 'Offshore', tide: 'Low',
  },
  { id: 20, date: '2024-03-02', spot: 'Lagoon Bay', board: 'Soft-top', waveCount: 6, mood: 'Relaxed',
    notes: 'Small but sunny, swimming with seals.', swellSize: 1, wind: 'Onshore', tide: 'Mid',
  },
  // Add further for mix (across all boards, moods, dates, tides, winds)
  { id: 21, date: '2024-02-27', spot: 'Crystal Cove', board: 'Shortboard', waveCount: 9, mood: 'Tired',
    notes: 'Workout after work, needed a recharge.', swellSize: 3, wind: 'Onshore', tide: 'High',
  },
  { id: 22, date: '2024-02-12', spot: 'Tide Rock', board: 'Longboard', waveCount: 7, mood: 'Relaxed',
    notes: 'Small waves, easy vibe, slow session.', swellSize: 2, wind: 'Sideshore', tide: 'Mid',
  },
  { id: 23, date: '2024-01-25', spot: 'Seaglass Beach', board: 'Fish', waveCount: 13, mood: 'Stoked',
    notes: 'Uncrowded, perfect take-off zone.', swellSize: 3, wind: 'Offshore', tide: 'Low',
  },
  { id: 24, date: '2024-01-18', spot: 'Lagoon Bay', board: 'Soft-top', waveCount: 7, mood: 'Frustrated',
    notes: 'Onshore, stormy, but committed to paddle.', swellSize: 6, wind: 'Onshore', tide: 'High',
  },
  { id: 25, date: '2024-01-03', spot: 'Coral Point', board: 'Funboard', waveCount: 10, mood: 'Inspired',
    notes: 'New Year, new board. Good vibes.', swellSize: 4, wind: 'Offshore', tide: 'Mid',
  }
];
